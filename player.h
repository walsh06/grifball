 ...
 *opp_ball {move_towards_ball, move_to_own_goal, move_left, move_right}
...
public:
    static const int MOVE_UP = 1, MOVE_DOWN = 2, MOVE_LEFT = 3, MOVE_RIGHT = 4, PASS = 5;
    static const int ATTACK = 6, MOVE_TO_BALL = 7, MOVE_TO_GOAL = 8, MOVE_TO_OWN_GOAL = 9;
